...
public:
	...
	bool addFronteiraDeParetoPSO(Solucao *s, list<Solucao> fronteira);//metodo que analiza solucao, e adiciona a variavel fronteira com a ideia da fronteira de pareto
	...
	/*PSO*/
	vector<vector < int > > toParticula(vector<Solucao> solucoes);
